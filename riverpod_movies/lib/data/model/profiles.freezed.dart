...
/// @nodoc
mixin _$Profiles {
  Map<String, Profile> get profiles => throw _privateConstructorUsedError;
...
class _$ProfilesImpl implements _Profiles {
  const _$ProfilesImpl({required final Map<String, Profile> profiles})
      : _profiles = profiles;
...
abstract class _Profiles implements Profiles {
  const factory _Profiles({required final Map<String, Profile> profiles}) =
      _$ProfilesImpl;
