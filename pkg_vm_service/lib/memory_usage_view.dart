// Fantastic example of how to use the VM Service to get memory usage pulled from
// https://github.com/fluttercandies/extended_image/blob/master/example/lib/common/widget/memory_usage_view.dart
